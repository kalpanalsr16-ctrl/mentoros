...
- `src/lib/llm/` — Claude API wrapper (`generateTeachingReply`, `classifyIntentWithClaude`, `generateConceptExplanation`, `generatePracticeSet`, `generateAssessment`)
